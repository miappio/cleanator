    ...
    FileStorage.prototype.init = function () {
        ...
        if (this.initDone) {
            ...
            if (!window.File || !window.FileReader || !window.Blob) {
                message = "window.File, window.FileReader and window.Blob need to be loaded before a4p.FileStorage!";
                ...
                message = "window.requestFileSystem() or window.webkitRequestFileSystem() required by a4p.FileStorage!";
                this.initTrigger = function(deferred) { deferred.reject(message); };
                launchEnd(this);
                ...
                message = "window.resolveLocalFileSystemURI or equivalent required by a4p.FileStorage!";
                this.initTrigger = function(deferred) { deferred.reject(message); };
                launchEnd(this);
            } else {
