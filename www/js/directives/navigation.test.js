...
describe('navigation directive', function() {
    ...
    beforeEach(module('myAngularApp.directives.navigation'));
    ...
    describe('initialisation', function() {
        ...
        it('should produce 2 buttons and 1 input', function() {
            expect(elm[0].querySelectorAll('.input-group-addon').length).toEqual(2);
            //expect(elm.find('input')).toEqual(1);
            expect(elm[0].querySelectorAll('.form-control').length).toEqual(1);
        });
