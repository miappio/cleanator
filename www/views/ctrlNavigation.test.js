describe('myAngularApp.views.ctrlNavigation', function () {
    'use strict';
    var $httpBackend, $rootScope, $timeout, $routeParams, $q, $controller, $stateProvider, $urlRouterProvider, $ionicConfigProvider;
    var _createController, _srvDataContainer;
    ...
    beforeEach(inject(function ($injector) {
        ...
        _createController = function () {
            ...
            return $controller('ctrlNavigation', {
                '$scope': $rootScope,
                '$timeout': $timeout,
                '$q': $q,
                'srvData': srvData,
